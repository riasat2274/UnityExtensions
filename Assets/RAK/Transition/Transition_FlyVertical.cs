...
namespace RAK
{
    public class Transition_FlyVertical : Transition
    {
        public Vector2 verticalInOutDists;

        bool initialized = false;
        public bool useAnchoredPos;
        ...
        Vector2 startPos => corePos + new Vector2(0, verticalInOutDists.x);
        Vector2 finalPos => corePos + new Vector2(0, verticalInOutDists.y);
